...
def get_belief_for_player_cheap(game_state: AvalonGameState, player_index: int, device: torch.device) -> Belief:
    """
...
def get_belief_for_player(game_state: AvalonGameState, player_index: int, device: torch.device) -> Belief:
    """
    Get the belief of the player with the given index.
    Use `belief.distribution` to get the probabilities of each role assignment.
    """
